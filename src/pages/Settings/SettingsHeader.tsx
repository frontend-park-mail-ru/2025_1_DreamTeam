  ...
  return (
    <header class="changes">
      ...
      <div class="change-select">
        <button class="choose__type__button" style="width: 314px;">
          <img
        ...
        <button class="choose__type__button" style="width: 218px;">
          <img src="../static/icons/mail.svg" alt="" class="editing__icon" />
          Изменить почту
        </button>
        <button class="choose__type__button" style="width: 232px;">
